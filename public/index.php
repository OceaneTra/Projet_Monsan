...
<body class="bg-gray-50 font-sans overflow-x-hidden">
    <nav class="bg-white shadow-sm px-6 py-4 sticky top-0 z-50 backdrop-blur-sm bg-white/95">
        <div class="max-w-7xl mx-auto flex justify-between items-center">
            ...
            <div class="flex items-center space-x-4">
                <a href="page_connexion.php" class="bg-primary text-white px-6 py-2 rounded-full hover:bg-primary-dark transition-all duration-300 hover:scale-105">
                    Connexion
                </a>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
            <div class="relative">
                ...
                <p class="text-gray-600 text-lg mb-8 max-w-md">
                    Notre plateforme centralise et optimise chaque étape du processus de soutenance pour les étudiants, enseignants et l'administration de l'Université FHB.
                </p>

                <div class="flex flex-col sm:flex-row gap-4">
                    <a href="page_connexion.php" class="bg-primary text-white px-8 py-4 rounded-full hover:bg-primary-dark transition-all duration-300 hover:scale-105 text-center font-semibold">
                        Accéder à mon Espace
                    </a>
                    <a href="#features" class="border-2 border-primary text-primary px-8 py-4 rounded-full hover:bg-primary hover:text-white transition-all duration-300 text-center font-semibold">
                        En Savoir Plus
                    </a>
                </div>
                     ...
                     <div class="w-80 h-80 hero-gradient rounded-full flex items-center justify-center relative">
                         <div class="relative">
                             <div class="w-32 h-32 bg-white rounded-full mb-4 relative overflow-hidden shadow-lg">
                                 ...
                                 <div class="absolute bottom-6 left-1/2 transform -translate-x-1/2 w-8 h-2 bg-primary rounded-full"></div>
                             </div>
                             <div class="w-24 h-16 bg-gray-800 rounded-lg mx-auto relative shadow-xl">
                                 <div class="w-20 h-12 bg-white rounded-sm absolute top-2 left-2 flex items-center justify-center">
                                     <div class="w-12 h-1 bg-primary rounded"></div>
                                 </div>
                             </div>
                         </div>
                     </div>
                     <div class="absolute -top-10 -right-10 w-20 h-20 bg-primary rounded-full animate-float opacity-80"></div>
    ...
    <section id="features" class="py-20 bg-gray-50">
        <div class="max-w-7xl mx-auto px-6">
            <div class="text-center mb-16">
                ...
                <p class="text-gray-600 max-w-2xl mx-auto">Découvrez comment nous facilitons la vie de toute la communauté universitaire.</p>
            </div>
            ...
            <div class="grid lg:grid-cols-3 gap-12">
                <div class="card-hover bg-white p-8 rounded-2xl shadow-lg">
                    ...
                    <p class="text-gray-600">
                        Déposez vos rapport en quelques clics, verifier l avancer de votre rapport et la progrmmation de la date . Fini les allers-retours interminables.
                    </p>
                </div>
                ...
                <div class="card-hover bg-white p-8 rounded-2xl shadow-lg">
                    ...
                    <p class="text-gray-600">
                        Recevez des notifications automatiques pour chaque étape validée. Suivez l'avancement de votre dossier 24/7.
                    </p>
                </div>
                ...
                <div class="card-hover bg-white p-8 rounded-2xl shadow-lg">
                    <div class="mb-6">
                        <div class="w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center mb-4">
                           <svg class="w-8 h-8 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 14v3m4-3v3m4-3v3M3 21h18M3 10h18M3 7l9-4 9 4M4 10h16v11H4V10z"></path></svg>
                        </div>
                    </div>
                    <h3 class="text-xl font-bold mb-4 text-gray-900">Archivage Numérique</h3>
                    <p class="text-gray-600">
                        Tous les mémoires, thèses et PV de soutenance sont archivés de manière sécurisée et accessible à tout moment.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-6 text-center">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="card-hover bg-gray-50 p-8 rounded-2xl border border-gray-100">
                    <div class="w-20 h-20 bg-primary/20 text-primary rounded-full mx-auto mb-6 flex items-center justify-center text-3xl font-bold">1</div>
                    <h3 class="font-bold text-lg mb-3 text-gray-900">Dépôt du Sujet</h3>
                    <p class="text-gray-600 text-sm">Soumettez votre proposition de mémoire ou de thèse directement sur la plateforme pour validation.</p>
                </div>
                <div class="card-hover bg-gray-50 p-8 rounded-2xl border border-gray-100">
                    <div class="w-20 h-20 bg-primary/20 text-primary rounded-full mx-auto mb-6 flex items-center justify-center text-3xl font-bold">2</div>
                    <h3 class="font-bold text-lg mb-3 text-gray-900">Validation Administrative</h3>
                    <p class="text-gray-600 text-sm">Votre UFR et votre directeur de thèse examinent et valident votre sujet et votre calendrier.</p>
                </div>
                <div class="card-hover bg-gray-50 p-8 rounded-2xl border border-gray-100">
                    <div class="w-20 h-20 bg-primary/20 text-primary rounded-full mx-auto mb-6 flex items-center justify-center text-3xl font-bold">3</div>
                    <h3 class="font-bold text-lg mb-3 text-gray-900">Planification du Jury</h3>
                    <p class="text-gray-600 text-sm">Coordonnez la date, l'heure et la salle avec les membres du jury disponibles sur la plateforme.</p>
                </div>
                <div class="card-hover bg-gray-50 p-8 rounded-2xl border border-gray-100">
                    <div class="w-20 h-20 bg-primary/20 text-primary rounded-full mx-auto mb-6 flex items-center justify-center text-3xl font-bold">4</div>
                    <h3 class="font-bold text-lg mb-3 text-gray-900">Soutenance & Archivage</h3>
                    <p class="text-gray-600 text-sm">Après la soutenance, déposez la version finale de votre document et recevez le PV numérique.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-20 bg-gray-50">
        <div class="max-w-7xl mx-auto px-6">
            <div class="text-center mb-16">
                ...
                <p class="text-gray-600 max-w-2xl mx-auto">Étudiants, enseignants et administrateurs partagent leur expérience.</p>
            </div>

            <div class="grid md:grid-cols-3 gap-8">
                <div class="card-hover bg-white p-8 rounded-2xl shadow-lg">
                    <div class="flex items-center mb-6">
                        <img class="w-12 h-12 rounded-full mr-4 object-cover" src="https://i.pravatar.cc/150?u=a042581f4e29026704d" alt="Photo de Marie Dubois">
                        <div>
                            <h4 class="font-bold text-gray-900">Aya Konan</h4>
                            <p class="text-gray-600 text-sm">Étudiante en Master de Droit</p>
                        </div>
                    </div>
                    <p class="text-gray-600 mb-4">"La plateforme a rendu l'organisation de ma soutenance tellement plus simple. Plus besoin de courir partout sur le campus !"</p>
                    <div class="text-accent">★★★★★</div>
                </div>

                <div class="card-hover bg-white p-8 rounded-2xl shadow-lg">
                    <div class="flex items-center mb-6">
                         <img class="w-12 h-12 rounded-full mr-4 object-cover" src="https://i.pravatar.cc/150?u=a042581f4e29026704a" alt="Photo de Prof. Kouamé">
                        <div>
                            <h4 class="font-bold text-gray-900">Prof. Kouamé</h4>
                            <p class="text-gray-600 text-sm">UFR Sciences Économiques</p>
                        </div>
                    </div>
                    <p class="text-gray-600 mb-4">"Avoir un calendrier centralisé pour toutes les soutenances est un gain de temps incroyable. Je peux gérer mon emploi du temps plus efficacement."</p>
                    <div class="text-accent">★★★★★</div>
                </div>

                <div class="card-hover bg-white p-8 rounded-2xl shadow-lg">
                    <div class="flex items-center mb-6">
                         <img class="w-12 h-12 rounded-full mr-4 object-cover" src="https://i.pravatar.cc/150?u=a042581f4e29026704b" alt="Photo de Mme Bamba">
                        <div>
                            <h4 class="font-bold text-gray-900">Mme. Bamba</h4>
                            <p class="text-gray-600 text-sm">Scolarité, UFR LLC</p>
                        </div>
                    </div>
                    <p class="text-gray-600 mb-4">"Le suivi administratif est plus fluide et l'archivage numérique nous a débarrassés de tonnes de papier. Une vraie révolution."</p>
                    <div class="text-accent">★★★★★</div>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-4xl mx-auto px-6 text-center">
            <div class="mb-8">
                ...
                <p class="text-white/80 mb-8 max-w-2xl mx-auto text-lg">
                    Rejoignez les milliers d'utilisateurs de l'Université Félix Houphouët-Boigny qui bénéficient déjà d'un processus de soutenance simplifié et efficace.
                </p>
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="page_connexion.php" class="bg-accent text-primary px-8 py-4 rounded-full hover:bg-yellow-500 transition-all duration-300 hover:scale-105 font-bold">
                         Se connecter
                    </a>
                    <a href="contact.php" class="border-2 border-white text-white px-8 py-4 rounded-full hover:bg-white hover:text-primary transition-all duration-300 font-bold">
                        Nous Contacter
                    </a>
                </div>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-6">
            <div class="grid md:grid-cols-4 gap-8 mb-8">
                <div>
                    ...
                    <p class="text-gray-400 mb-4">La plateforme officielle pour la gestion des soutenances de MATH-INFO à l'Université Félix Houphouët-Boigny.</p>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-gray-400">
                        ...
                        <li><a href="page_connexion.php" class="hover:text-white transition">Espace Administration</a></li>
                    </ul>
                </div>
            ...
            <div class="border-t border-gray-800 pt-8 text-center">
                <p class="text-gray-400">© 2025 SoutenanceFHB - Université Félix Houphouët-Boigny. Tous droits réservés.</p>
            </div>
        </div>
    </footer>
    ...
    document.querySelectorAll('.card-hover').forEach(card => {
        ...
        card.style.transition = 'opacity 0.6s ease-out, transform 0.6s ease-out, box-shadow 0.3s ease, background-color 0.3s ease';
